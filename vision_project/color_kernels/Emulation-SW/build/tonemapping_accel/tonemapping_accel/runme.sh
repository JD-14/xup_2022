...
HD_PWD='/home/centos/Documents/vision_project/color_kernels/Emulation-SW/build/tonemapping_accel/tonemapping_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f tonemapping_accel.tcl -messageDb vitis_hls.pb
