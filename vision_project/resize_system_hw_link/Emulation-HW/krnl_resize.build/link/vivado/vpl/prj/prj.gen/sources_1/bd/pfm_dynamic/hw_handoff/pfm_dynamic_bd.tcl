...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/resize_accel_1} [get_bd_cells /System_DPA/dpa_mon0]
  ...
  set_property -dict [ list \
   ...
   CONFIG.MONITOR_ID {resize_accel_1:m_axi_gmem1-DDR[1]} \
   CONFIG.TRACE_READ_ID {0} \
   CONFIG.TRACE_WRITE_ID {1} \
 ] $dpa_mon1
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/resize_accel_1/m_axi_gmem1-DDR[1]} [get_bd_cells /System_DPA/dpa_mon1]
  ...
  set_property -dict [ list \
   ...
   CONFIG.EN_AXI_LITE {1} \
   CONFIG.MODE_SDACCEL {true} \
   CONFIG.MONITOR_ID {resize_accel_1:m_axi_gmem2-DDR[1]} \
   CONFIG.TRACE_READ_ID {2} \
   CONFIG.TRACE_WRITE_ID {3} \
 ] $dpa_mon2
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/resize_accel_1/m_axi_gmem2-DDR[1]} [get_bd_cells /System_DPA/dpa_mon2]
  ...
  connect_bd_intf_net -intf_net resize_accel_1_m_axi_gmem1 [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon1/MON_M_AXI]
  connect_bd_intf_net -intf_net resize_accel_1_m_axi_gmem2 [get_bd_intf_pins MON_M_AXI1] [get_bd_intf_pins dpa_mon2/MON_M_AXI]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins trace_rst] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M02_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M03_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M04_ARESETN] [get_bd_pins dpa_hub/axilite_aresetn] [get_bd_pins dpa_hub/trace_aresetn] [get_bd_pins dpa_mon0/mon_resetn] [get_bd_pins dpa_mon0/trace_rst] [get_bd_pins dpa_mon1/mon_resetn] [get_bd_pins dpa_mon1/trace_rst] [get_bd_pins dpa_mon2/mon_resetn] [get_bd_pins dpa_mon2/trace_rst]
...
SLR1 aws_ddrc SLR1 aws_ddrd SLR0}}}\
  ...
  # Create instance: resize_accel_1, and set properties
  set resize_accel_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:resize_accel:1.0 resize_accel_1 ]
  ...
  connect_bd_intf_net -intf_net resize_accel_1_m_axi_gmem1 [get_bd_intf_pins memory_subsystem/S04_AXI] [get_bd_intf_pins resize_accel_1/m_axi_gmem1]
connect_bd_intf_net -intf_net [get_bd_intf_nets resize_accel_1_m_axi_gmem1] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins memory_subsystem/S04_AXI]
  connect_bd_intf_net -intf_net resize_accel_1_m_axi_gmem2 [get_bd_intf_pins memory_subsystem/S05_AXI] [get_bd_intf_pins resize_accel_1/m_axi_gmem2]
connect_bd_intf_net -intf_net [get_bd_intf_nets resize_accel_1_m_axi_gmem2] [get_bd_intf_pins System_DPA/MON_M_AXI1] [get_bd_intf_pins memory_subsystem/S05_AXI]
  connect_bd_intf_net -intf_net slr1_M01_AXI [get_bd_intf_pins resize_accel_1/s_axi_control] [get_bd_intf_pins slr1/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets slr1_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins slr1/M01_AXI]
  ...
  connect_bd_net -net resize_accel_1_interrupt [get_bd_pins interrupt_concat/In0] [get_bd_pins resize_accel_1/interrupt]
  connect_bd_net -net slowest_sync_clk_0_1 [get_bd_pins System_DPA/trace_clk] [get_bd_pins kernel_clk/clk] [get_bd_pins memory_subsystem/aclk1] [get_bd_pins resize_accel_1/ap_clk] [get_bd_pins slr0/slowest_sync_clk] [get_bd_pins slr1/slowest_sync_clk] [get_bd_pins slr2/slowest_sync_clk]
  ...
  connect_bd_net -net slr1_peripheral_aresetn [get_bd_pins System_DPA/trace_rst] [get_bd_pins resize_accel_1/ap_rst_n] [get_bd_pins slr1/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M01_AXI_MEM00] -force
  assign_bd_address -offset 0x000400000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M01_AXI_MEM00] -force
  ...
  assign_bd_address -offset 0x1D050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces userpf_control_M_AXI] [get_bd_addr_segs resize_accel_1/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M00_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004800000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M02_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x004C00000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/M03_AXI_MEM00]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x005000020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x005000040000 -range 0x00020000 -target_address_space [get_bd_addr_spaces resize_accel_1/Data_m_axi_gmem2] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM02]
