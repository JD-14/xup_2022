...
module resize_accel_xfMat2Array_128_0_1080_1920_1_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] srcMat_cols_read_reg_76;
wire   [15:0] trunc_ln1498_fu_72_p1;
reg   [15:0] trunc_ln1498_reg_81;
wire    ap_CS_fsm_state2;
wire    grp_Mat2Axi_fu_60_out_mat_421_read;
...
wire   [127:0] grp_Mat2Axi_fu_60_m_axi_gmem2_WDATA;
wire   [15:0] grp_Mat2Axi_fu_60_m_axi_gmem2_WSTRB;
...
wire    grp_Mat2Axi_fu_60_ap_ext_blocking_n;
wire    grp_Mat2Axi_fu_60_ap_str_blocking_n;
wire    grp_Mat2Axi_fu_60_ap_int_blocking_n;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state3) & (ap_sync_grp_Mat2Axi_fu_60_ap_ready == 1'b0)))) begin
...
always @ (*) begin
    if (((ap_start == 1'b0) | (srcMat_cols_empty_n == 1'b0) | (srcMat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if ((grp_Mat2Axi_fu_60_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_Mat2Axi_fu_60_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_Mat2Axi_fu_60_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (srcMat_cols_empty_n == 1'b0) | (srcMat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (srcMat_cols_empty_n == 1'b0) | (srcMat_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state3_on_subcall_done = ((ap_sync_grp_Mat2Axi_fu_60_ap_ready & ap_sync_grp_Mat2Axi_fu_60_ap_done) == 1'b0);
end

assign ap_ext_blocking_n = (ap_ext_blocking_sub_n & 1'b1);

assign ap_int_blocking_cur_n = (srcMat_rows_blk_n & srcMat_cols_blk_n);
...
assign trunc_ln1498_fu_72_p1 = srcMat_rows_dout[15:0];

endmodule //resize_accel_xfMat2Array_128_0_1080_1920_1_1_s
