...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_resize_accel_1_0"]
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "krnl_resize" \
  kernels                  "resize_accel" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs_synth            4 \
...
set data_profile_resize_accel_1_M_AXI_GMEM1 [dict create \
  port resize_accel_1/M_AXI_GMEM1 \
  option all \
];
set data_profile_resize_accel_1_M_AXI_GMEM2 [dict create \
  port resize_accel_1/M_AXI_GMEM2 \
  option all \
];
set dict_profile [dict create \
  ...
  FIFO "8192" \
  AIE [list] \
  DATA [list $data_profile_resize_accel_1_M_AXI_GMEM1 $data_profile_resize_accel_1_M_AXI_GMEM2] \
  STALL [list] \
  EXEC [list] \
