...
module resize_accel_Array2xfMat_128_0_2160_3840_1_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [127:0] grp_Axi2Mat_fu_82_m_axi_gmem1_WDATA;
wire   [15:0] grp_Axi2Mat_fu_82_m_axi_gmem1_WSTRB;
...
wire   [7:0] grp_Axi2Mat_fu_82_in_mat_420_din;
wire    grp_Axi2Mat_fu_82_in_mat_420_write;
...
wire    grp_Axi2Mat_fu_82_ap_ext_blocking_n;
wire    grp_Axi2Mat_fu_82_ap_str_blocking_n;
wire    grp_Axi2Mat_fu_82_ap_int_blocking_n;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((((1'b1 == ap_CS_fsm_state2) & (ap_sync_grp_Axi2Mat_fu_82_ap_ready == 1'b0)) | (~((in_mat_cols_c_full_n == 1'b0) | (in_mat_rows_c_full_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if (((in_mat_cols_c_full_n == 1'b0) | (in_mat_rows_c_full_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if ((grp_Axi2Mat_fu_82_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_Axi2Mat_fu_82_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_Axi2Mat_fu_82_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((~((in_mat_cols_c_full_n == 1'b0) | (in_mat_rows_c_full_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((in_mat_cols_c_full_n == 1'b0) | (in_mat_rows_c_full_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

always @ (*) begin
    ap_block_state1_ignore_call9 = ((in_mat_cols_c_full_n == 1'b0) | (in_mat_rows_c_full_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign in_mat_420_din = grp_Axi2Mat_fu_82_in_mat_420_din;

assign in_mat_cols_c_din = p_read2;

assign in_mat_rows_c_din = p_read1;
...
endmodule //resize_accel_Array2xfMat_128_0_2160_3840_1_s
