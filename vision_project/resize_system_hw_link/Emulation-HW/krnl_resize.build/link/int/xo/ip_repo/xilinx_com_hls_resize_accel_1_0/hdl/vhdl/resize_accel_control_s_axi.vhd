...
architecture behave of resize_accel_control_s_axi is
    ...
    constant ADDR_ROWS_IN_DATA_0  : INTEGER := 16#28#;
    constant ADDR_ROWS_IN_CTRL    : INTEGER := 16#2c#;
    constant ADDR_COLS_IN_DATA_0  : INTEGER := 16#30#;
    constant ADDR_COLS_IN_CTRL    : INTEGER := 16#34#;
    constant ADDR_ROWS_OUT_DATA_0 : INTEGER := 16#38#;
    constant ADDR_ROWS_OUT_CTRL   : INTEGER := 16#3c#;
    constant ADDR_COLS_OUT_DATA_0 : INTEGER := 16#40#;
    constant ADDR_COLS_OUT_CTRL   : INTEGER := 16#44#;
