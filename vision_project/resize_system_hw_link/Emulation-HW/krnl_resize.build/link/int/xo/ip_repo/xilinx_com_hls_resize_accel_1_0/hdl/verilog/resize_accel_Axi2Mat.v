...
wire   [63:0] entry_proc6_U0_ap_return;
...
wire    Axi2Mat_Block_split35_proc_U0_ap_start;
wire    Axi2Mat_Block_split35_proc_U0_ap_done;
wire    Axi2Mat_Block_split35_proc_U0_ap_continue;
wire    Axi2Mat_Block_split35_proc_U0_ap_idle;
wire    Axi2Mat_Block_split35_proc_U0_ap_ready;
wire   [19:0] Axi2Mat_Block_split35_proc_U0_ap_return;
wire    Axi2Mat_Block_split35_proc_U0_ap_ext_blocking_n;
wire    Axi2Mat_Block_split35_proc_U0_ap_str_blocking_n;
wire    Axi2Mat_Block_split35_proc_U0_ap_int_blocking_n;
...
wire   [127:0] Axi2AxiStream_U0_m_axi_gmem1_WDATA;
wire   [15:0] Axi2AxiStream_U0_m_axi_gmem1_WSTRB;
...
wire   [127:0] Axi2AxiStream_U0_ldata1_din;
...
wire   [7:0] AxiStream2Mat_U0_in_mat_420_din;
wire    AxiStream2Mat_U0_in_mat_420_write;
...
resize_accel_entry_proc6 entry_proc6_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_Axi2Mat_Block_split35_proc Axi2Mat_Block_split35_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
resize_accel_AxiStream2Mat AxiStream2Mat_U0(
...
resize_accel_fifo_w64_d3_S din_c_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w20_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d4_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w32_d4_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w20_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_fifo_w128_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
resize_accel_start_for_AxiStream2Mat_U0 start_for_AxiStream2Mat_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Axi2Mat_Block_split35_proc_U0_ap_continue = axibound_V_full_n;

assign Axi2Mat_Block_split35_proc_U0_ap_start = p_channel_empty_n;
...
assign ap_ext_blocking_sub_n = (entry_proc6_U0_ap_ext_blocking_n & addrbound_U0_ap_ext_blocking_n & AxiStream2Mat_U0_ap_ext_blocking_n & Axi2Mat_Block_split35_proc_U0_ap_ext_blocking_n & Axi2AxiStream_U0_ap_ext_blocking_n);

assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & (din_c_channel_empty_n ^ 1'b1) & entry_proc6_U0_ap_idle & addrbound_U0_ap_idle & AxiStream2Mat_U0_ap_idle & Axi2Mat_Block_split35_proc_U0_ap_idle & Axi2AxiStream_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (entry_proc6_U0_ap_int_blocking_n & addrbound_U0_ap_int_blocking_n & AxiStream2Mat_U0_ap_int_blocking_n & Axi2Mat_Block_split35_proc_U0_ap_int_blocking_n & Axi2AxiStream_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (entry_proc6_U0_ap_str_blocking_n & addrbound_U0_ap_str_blocking_n & AxiStream2Mat_U0_ap_str_blocking_n & Axi2Mat_Block_split35_proc_U0_ap_str_blocking_n & Axi2AxiStream_U0_ap_str_blocking_n);
...
assign ap_sync_ready = (ap_sync_entry_proc6_U0_ap_ready & ap_sync_addrbound_U0_ap_ready & ap_sync_Axi2AxiStream_U0_ap_ready);

assign entry_proc6_U0_ap_continue = din_c_channel_full_n;

assign entry_proc6_U0_ap_start = ((ap_sync_reg_entry_proc6_U0_ap_ready ^ 1'b1) & ap_start);

assign in_mat_420_din = AxiStream2Mat_U0_in_mat_420_din;

assign in_mat_420_write = AxiStream2Mat_U0_in_mat_420_write;
