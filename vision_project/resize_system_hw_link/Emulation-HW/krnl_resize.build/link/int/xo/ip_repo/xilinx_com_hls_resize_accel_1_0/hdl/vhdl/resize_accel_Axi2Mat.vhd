...
entity resize_accel_Axi2Mat is
port (
...
architecture behav of resize_accel_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc6_U0_ap_return : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal addrbound_U0_start_out : STD_LOGIC;
    signal addrbound_U0_start_write : STD_LOGIC;
    signal addrbound_U0_return_r : STD_LOGIC_VECTOR (19 downto 0);
    signal addrbound_U0_rows_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal addrbound_U0_rows_c_write : STD_LOGIC;
    signal addrbound_U0_cols_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal addrbound_U0_cols_c_write : STD_LOGIC;
    ...
    signal Axi2Mat_Block_split35_proc_U0_ap_return : STD_LOGIC_VECTOR (19 downto 0);
    signal Axi2Mat_Block_split35_proc_U0_ap_ext_blocking_n : STD_LOGIC;
    signal Axi2Mat_Block_split35_proc_U0_ap_str_blocking_n : STD_LOGIC;
    signal Axi2Mat_Block_split35_proc_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    signal Axi2AxiStream_U0_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (127 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal Axi2AxiStream_U0_ldata1_din : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal AxiStream2Mat_U0_in_mat_420_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2Mat_U0_in_mat_420_write : STD_LOGIC;
    ...
    component resize_accel_entry_proc6 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component resize_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component resize_accel_Axi2Mat_Block_split35_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component resize_accel_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component resize_accel_AxiStream2Mat IS
    port (
    ...
    component resize_accel_fifo_w64_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component resize_accel_fifo_w20_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component resize_accel_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component resize_accel_fifo_w128_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component resize_accel_start_for_AxiStream2Mat_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc6_U0 : component resize_accel_entry_proc6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        din => din,
        ap_return => entry_proc6_U0_ap_return,
    ...
    addrbound_U0 : component resize_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        start_out => addrbound_U0_start_out,
        start_write => addrbound_U0_start_write,
    ...
    Axi2Mat_Block_split35_proc_U0 : component resize_accel_Axi2Mat_Block_split35_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_ext_blocking_n => Axi2Mat_Block_split35_proc_U0_ap_ext_blocking_n,
        ap_str_blocking_n => Axi2Mat_Block_split35_proc_U0_ap_str_blocking_n,
        ap_int_blocking_n => Axi2Mat_Block_split35_proc_U0_ap_int_blocking_n);

    Axi2AxiStream_U0 : component resize_accel_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2Mat_U0 : component resize_accel_AxiStream2Mat
    port map (
        ldata1_dout => ldata_dout,
        ldata1_empty_n => ldata_empty_n,
        ldata1_read => AxiStream2Mat_U0_ldata1_read,
        in_mat_420_din => AxiStream2Mat_U0_in_mat_420_din,
        in_mat_420_full_n => in_mat_420_full_n,
        in_mat_420_write => AxiStream2Mat_U0_in_mat_420_write,
    ...
    din_c_channel_U : component resize_accel_fifo_w64_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc6_U0_ap_return,
        if_full_n => din_c_channel_full_n,
        if_write => entry_proc6_U0_ap_done,
        if_dout => din_c_channel_dout,
        if_empty_n => din_c_channel_empty_n,
        if_read => Axi2AxiStream_U0_ap_ready);

    p_channel_U : component resize_accel_fifo_w20_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    rows_c_U : component resize_accel_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c_U : component resize_accel_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component resize_accel_fifo_w20_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component resize_accel_fifo_w128_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AxiStream2Mat_U0_U : component resize_accel_start_for_AxiStream2Mat_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_write => addrbound_U0_start_write,
    ...
    Axi2Mat_Block_split35_proc_U0_ap_continue <= axibound_V_full_n;
    Axi2Mat_Block_split35_proc_U0_ap_start <= p_channel_empty_n;
    ...
    ap_ext_blocking_sub_n <= (entry_proc6_U0_ap_ext_blocking_n and addrbound_U0_ap_ext_blocking_n and AxiStream2Mat_U0_ap_ext_blocking_n and Axi2Mat_Block_split35_proc_U0_ap_ext_blocking_n and Axi2AxiStream_U0_ap_ext_blocking_n);
    ap_idle <= ((axibound_V_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and (din_c_channel_empty_n xor ap_const_logic_1) and entry_proc6_U0_ap_idle and addrbound_U0_ap_idle and AxiStream2Mat_U0_ap_idle and Axi2Mat_Block_split35_proc_U0_ap_idle and Axi2AxiStream_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (entry_proc6_U0_ap_int_blocking_n and addrbound_U0_ap_int_blocking_n and AxiStream2Mat_U0_ap_int_blocking_n and Axi2Mat_Block_split35_proc_U0_ap_int_blocking_n and Axi2AxiStream_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (entry_proc6_U0_ap_str_blocking_n and addrbound_U0_ap_str_blocking_n and AxiStream2Mat_U0_ap_str_blocking_n and Axi2Mat_Block_split35_proc_U0_ap_str_blocking_n and Axi2AxiStream_U0_ap_str_blocking_n);
    ...
    ap_sync_ready <= (ap_sync_entry_proc6_U0_ap_ready and ap_sync_addrbound_U0_ap_ready and ap_sync_Axi2AxiStream_U0_ap_ready);
    entry_proc6_U0_ap_continue <= din_c_channel_full_n;
