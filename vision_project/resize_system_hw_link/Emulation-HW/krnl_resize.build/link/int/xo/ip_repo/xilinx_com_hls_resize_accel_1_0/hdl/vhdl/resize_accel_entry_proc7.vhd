...
entity resize_accel_entry_proc7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of resize_accel_entry_proc7 is 
...
begin
    ...
    ap_return_0_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, img_inp, ap_return_0_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_0 <= img_inp;
        else 
    ...
    ap_return_1_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, img_out, ap_return_1_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_1 <= img_out;
        else 
