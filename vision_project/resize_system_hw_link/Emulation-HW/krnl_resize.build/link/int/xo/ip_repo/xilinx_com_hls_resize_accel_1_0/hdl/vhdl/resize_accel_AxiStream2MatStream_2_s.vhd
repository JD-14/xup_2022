...
entity resize_accel_AxiStream2MatStream_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of resize_accel_AxiStream2MatStream_2_s is 
...
attribute shreg_extract : string;
    ...
    signal sub4_fu_94_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub4_reg_144 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub31_fu_101_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal sub31_reg_149 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln1021_fu_108_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln1021_reg_154 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62_in_mat_420_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62_in_mat_420_write : STD_LOGIC;
    ...
    signal last_blk_width_cast2_fu_82_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component resize_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component resize_accel_mul_32s_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62 : component resize_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    mul_32s_32s_32_2_1_U34 : component resize_accel_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    add_ln1021_fu_108_p2 <= std_logic_vector(unsigned(last_blk_width_cast2_fu_82_p1) + unsigned(ap_const_lv8_7F));
    ...
    in_mat_420_write_assign_proc : process(grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62_in_mat_420_write, ap_CS_fsm_state4)
    begin
    ...
    last_blk_width_cast2_fu_82_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(last_blk_width_read_reg_127),8));
    ...
    sub31_fu_101_p2 <= std_logic_vector(unsigned(last_blk_width_cast5_fu_85_p1) + unsigned(ap_const_lv5_1F));
    sub4_fu_94_p2 <= std_logic_vector(signed(ap_const_lv8_80) - signed(last_blk_width_cast2_fu_82_p1));
