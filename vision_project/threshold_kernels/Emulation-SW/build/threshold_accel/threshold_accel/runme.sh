...
HD_PWD='/home/centos/Documents/vision_project/threshold_kernels/Emulation-SW/build/threshold_accel/threshold_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f threshold_accel.tcl -messageDb vitis_hls.pb
