...
HD_PWD='/home/centos/Documents/project/color_kernels/Emulation-SW/build/cvtcolor_bgr2gray/cvtcolor_bgr2gray'
cd "$HD_PWD"
...
EAStep vitis_hls -f cvtcolor_bgr2gray.tcl -messageDb vitis_hls.pb
