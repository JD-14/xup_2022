...
HD_PWD='/home/centos/Documents/project/correct_kernels/Emulation-SW/build/convertbitdepth/convertbitdepth'
cd "$HD_PWD"
...
EAStep vitis_hls -f convertbitdepth.tcl -messageDb vitis_hls.pb
