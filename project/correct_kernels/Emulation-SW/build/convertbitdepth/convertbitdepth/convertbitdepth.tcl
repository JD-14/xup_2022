...
open_project convertbitdepth
set_top convertbitdepth
# v++ -g, -D, -I, --advanced.prop kernel.convertbitdepth.kernel_flags
add_files "/home/centos/Documents/project/correct_kernels/src/xf_convertbitdepth_accel.cpp" -cflags " -g -I /home/centos/Documents/project/correct_kernels/src -I /home/centos/Documents/project/correct_kernels/libs/xf_opencv/L1/include -I /home/centos/Documents/project/correct_kernels/src/build "
...
config_export -format ip_catalog -ipname convertbitdepth
