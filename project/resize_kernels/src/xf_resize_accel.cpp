...
// clang-format off
    ...
    xf::cv::Mat<TYPE, NEWHEIGHT, NEWWIDTH, NPC_T> out_thrsh(rows_out, cols_out);
// clang-format off
...
// clang-format off
    ...
    xf::cv::Threshold<TYPE, XF_8UC1, HEIGHT, WIDTH, NPC_T>(out_mat, out_thrsh, thresh, maxval);
    xf::cv::xfMat2Array<OUTPUT_PTR_WIDTH, TYPE, NEWHEIGHT, NEWWIDTH, NPC_T>(out_thrsh, img_out);
}
}
