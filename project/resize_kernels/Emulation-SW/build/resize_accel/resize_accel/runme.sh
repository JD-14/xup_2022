...
HD_PWD='/home/centos/Documents/project/resize_kernels/Emulation-SW/build/resize_accel/resize_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f resize_accel.tcl -messageDb vitis_hls.pb
